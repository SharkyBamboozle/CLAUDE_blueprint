...
| D-004 | Enforcement doctrine: every process rule names its enforcer or is explicitly advisory with a reason; enforcement layers prose → hooks → CI; exceptions are reasoned commit trailers; exception lists are four-rule ledgers; no silent gate lanes | ✅ | [ADR-0004](adr-0004-enforcement-doctrine.md) |
