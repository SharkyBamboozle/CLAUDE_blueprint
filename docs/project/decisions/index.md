...
| D-008 | Docs layout: one top-level tab = one directory under `docs/` — the Project tab maps to `docs/project/` (the four project-meta sections), each domain area to its own `docs/<area>/`; the docs root reserves no names beyond Home and the tab directories | ✅ | [ADR-0008](adr-0008-docs-layout.md) |
