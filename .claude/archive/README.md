# Agent working-doc archive

Closed working docs, filed by `/handoff` as `YYYY-MM-DD/<task-slug>/`.

- **Append-only.** Entries are never deleted or rewritten; deletion happens
